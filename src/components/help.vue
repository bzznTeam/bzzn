<template>
	<div class="help">
		<div class="banner" :style="{height: bannerH+'px'}">
    		<div class="pic">
    			<img src="../../static/img/help_banner.jpg" alt="">
    		</div>
    		<div class="text">
    	...
    	<div class="box1">
			<ul>
				<li v-for="(item,index) in btns" :key="index" :class="isactive == index ? 'active':''" @click="tabToggle(index,item.from)">
					<button>{{item.tit}}</button>
				</li>
			</ul>
		</div>
		<div class="box2 w1400"  v-cloak>
...
export default {
    	...
    	return {
    		...
    		list:[
    			...
    			},
    			{
    				...
    				content:'答：第一套充值模版路径：ROOT&#92;jsp&#92;recharge&#92;temp4&#92;_foot.jsp　　订单查询，官方卡类查询，以上2项只能替换保留其中一项进行替换 第二套充值模版路径：ROOT&#92;jsp&#92;recharge&#92;temp5&#92;_foot.jsp　　订单查询，官方卡类查询，以上2项只能替换保留其中一项进行替换 第三套充值模版路径：ROOT&#92;jsp&#92;recharge&#92;temp6&#92;query_order.jsp　　订单查询，官方卡类查询，以上2项只能替换保留其中一项进行替换 替换代码： <a href="http://wpa.qq.com/msgrd?v=1&uin=QQ号码&site=qq&menu=yes" target="_blank"> <img border="0" title="平台客服" alt="平台客服" src="http://wpa.qq.com/pa?p=1:QQ号码:1" /> 注意以上文件必须用记事本方式打开修改替换'
    			},
    			{
  	...
  	methods: {
    	GetHeight(){
    		this.bannerH = $(window).width()*0.23958;
