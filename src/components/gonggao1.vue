    ...
    <div class="con_con">
      <div class="con2">
        ...
        <div class="top">
          <div class="right">
            <ul>
              <li v-for="(item,index) in gonggaoList" >
                <!--<router-link :to="/about/gonggao/news/id=item.noticeId" :data-id="item.noticeId">-->
                <router-link target="_blank" :to="{path:  '/news', query:{url:'findNotice?id='+item.id}}" :data-id="item.id">
                  <div class="right_con">
                    <p>{{item.title}}</p>
